...
public class GingerBean extends javax.swing.JPanel {
    ...
    public int getPoints(boolean glasshouse)
    {
        ...
        if (glasshouse == false)
        {
            ...
            {
                case DROUGHT -> bonus = 2 * points;
                case FROST -> bonus = -2 * points;
            }
        }
        points *= 3;
    ...
    private void initComponents() {
        ...
        calcBean1.setVegetableName("Ginger [1/2]");
        calcBean1.setVegetablePath("/res/ginger_1.png");
        add(calcBean1, new java.awt.GridBagConstraints());

        calcBean2.setVegetableName("Ginger [2/2]");
        calcBean2.setVegetablePath("/res/ginger_2.png");
