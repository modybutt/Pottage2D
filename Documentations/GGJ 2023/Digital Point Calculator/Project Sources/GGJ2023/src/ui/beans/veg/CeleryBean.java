...
public class CeleryBean extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        calcBean1.setVegetableName("Celery [1/2]");
        calcBean1.setVegetablePath("/res/celery_1.png");
        add(calcBean1, new java.awt.GridBagConstraints());

        calcBean2.setVegetableName("Celery [2/2]");
        calcBean2.setVegetablePath("/res/celery_2.png");
