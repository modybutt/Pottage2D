...
public class BeetRootBean extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        calcBean1.setVegetableName("Beetroot [1/2]");
        calcBean1.setVegetablePath("/res/beetroot_1.png");
        add(calcBean1, new java.awt.GridBagConstraints());

        calcBean2.setVegetableName("Beetroot [2/2]");
        calcBean2.setVegetablePath("/res/beetroot_2.png");
